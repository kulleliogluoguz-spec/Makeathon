const translations = {
  en: {
    ...
    nav_leads: "Lead Finder",
    nav_meetings: "Meetings",
    nav_voice_agent: "Voice Agent",
    nav_broadcasts: "Broadcasts",
    nav_landing_pages: "Landing Pages",
    cat_high_sales_potential: "High Sales Potential",
    cat_sales_potential: "Sales Potential",
    cat_no_sales_potential: "No Sales Potential",
    leads_presets: "Quick Presets",
    leads_presets_desc: "One-click filters for common lead searches. You can edit the criteria after selecting.",
    leads_criteria: "Search Criteria",
    leads_job_titles: "JOB TITLES",
    leads_seniorities: "SENIORITY LEVELS",
    leads_locations: "LOCATIONS",
    leads_company_size: "COMPANY SIZE",
    leads_keywords: "KEYWORDS",
    leads_value_prop: "VALUE PROPOSITION",
    leads_reach_out: "Reach out to",
    leads_why: "Why this lead",
    leads_approach: "Approach",
    leads_copy_msg: "Copy Message",
    leads_open_linkedin: "Open LinkedIn Profile",
    leads_save_contacted: "Save & Mark as Contacted",
  },
  tr: {
    ...
    nav_leads: "Potansiyel Müşteri",
    nav_meetings: "Görüşmeler",
    nav_voice_agent: "Sesli Asistan",
    nav_broadcasts: "Yayınlar",
    nav_landing_pages: "Landing Sayfaları",
    cat_high_sales_potential: "Yüksek Satış Potansiyeli",
    cat_sales_potential: "Satış Potansiyeli Var",
    cat_no_sales_potential: "Satış Potansiyeli Yok",
    leads_presets: "Hazır Filtreler",
    leads_presets_desc: "Yaygın lead aramaları için tek tıkla filtreler. Seçtikten sonra düzenleyebilirsiniz.",
    leads_criteria: "Arama Kriterleri",
    leads_job_titles: "POZİSYONLAR",
    leads_seniorities: "KIDEMLİLİK SEVİYELERİ",
    leads_locations: "LOKASYONLAR",
    leads_company_size: "ŞİRKET BÜYÜKLÜĞÜ",
    leads_keywords: "ANAHTAR KELİMELER",
    leads_value_prop: "DEĞER ÖNERİSİ",
    leads_reach_out: "İletişime geç",
    leads_why: "Neden bu lead",
    leads_approach: "Yaklaşım",
    leads_copy_msg: "Mesajı Kopyala",
    leads_open_linkedin: "LinkedIn Profilini Aç",
    leads_save_contacted: "Kaydet & İletişime Geçildi",
  },
};
